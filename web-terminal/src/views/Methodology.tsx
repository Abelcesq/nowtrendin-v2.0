    ...
    <>
      ...
      <div className="mth">
        ...
        <section className="mth-sec">
          ...
          <div className="mth-card">
            <p className="mth-p">Every notable detection is time-stamped and later validated against what actually happened — a permanent, auditable record, denominator included. We report it as it is; we do not market a number we cannot defend. There are <b>three</b> ledgers with three different ground truths: the <b>Attention</b> ledger validates against the topic's <b>Google Trends breakout</b> (did attention arrive?); the <b>Money</b> ledger validates against the realized <b>EOD price direction</b> (did the market move the way the detected flow indicated?); the <b>Crypto</b> ledger validates against the realized <b>coin price direction</b>. A fourth, pre-registered <b>flow/arrival</b> ledger accrues under sealed criteria and publishes nothing until its pre-declared minimum evidence exists. All are retrospective measurements of our own accuracy — see the <b>Accuracy Ledger</b> tab (toggle Attention / Money / Crypto) for the live record. Rates a ledger's clean sample does not yet support are <b>withheld by design</b> rather than published.</p>
          </div>
        </section>
