...
| **Heroku total (NowTrendIn footprint)** | **$118** | = `COST_HEROKU_USD` (2026-09-14, Chairman-ordered: **August 2026 invoice ACTUAL $122.81** whole-account, minus the $5 `mytaskapp` personal app → $117.81 footprint, rounded up). Prior estimate $112 (2026-07-05) under-counted ~$6/mo. ⚠ Founder: update the `COST_HEROKU_USD` config var on `nowtrendin-v2-engine` to `118` — the set env var overrides the code default. |
