...
import { Signal, ageLabel, stageColor, stageLabel, titleCaseTopic } from '../../lib/signals';
    ...
    >
      <View className="flex-row items-center justify-between">
        <View className="flex-1 pr-3">
          <Text className="text-textPrimary font-semibold text-base">{titleCaseTopic(signal.topic)}</Text>
